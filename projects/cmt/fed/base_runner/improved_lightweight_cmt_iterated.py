...
# Update these paths if you want to use these hooks!
custom_imports = dict(
    imports=['projects.cmt.hooks.disable_gt_sampling', 'projects.cmt.hooks.force_stop', 'projects.cmt.hooks.fisher_hook'], 
...
custom_hooks = [
    ...
    dict(
        type='FisherComputationHook',
        save_path='/workspace/work_dirs/client_A/fisher_matrix.pth', # <--- Update per client!
        num_batches=100  # 100 is usually a good sweet spot for a stable estimate
    )
]
