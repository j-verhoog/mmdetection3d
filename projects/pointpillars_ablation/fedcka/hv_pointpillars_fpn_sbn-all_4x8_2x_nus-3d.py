...
custom_imports = dict(
    imports=['projects.pointpillars_ablation.hooks.disable_gt_sampling', 'projects.pointpillars_ablation.hooks.force_stop', 'projects.pointpillars_ablation.hooks.fedselect_local'], 
