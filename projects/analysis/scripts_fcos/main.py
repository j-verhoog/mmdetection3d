...
def main():
    ...
    parser.add_argument('--modality', type=str, required=True, help="Data modality (lidar, camera)")
    ...
    if args.modality not in ['lidar', 'camera']:
        print("ERROR: Modality must be 'lidar' or 'camera'")
        return
    ...
    comparator = ModelComparator(args.config, sample_files, os.path.join(args.output_dir, "temp"))
