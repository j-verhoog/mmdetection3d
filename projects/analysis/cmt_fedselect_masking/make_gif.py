...
# ==========================================
# The folder containing the source image files
INPUT_FOLDER = "/home/jolle/mmdet/mmdetection3d/projects/analysis/cmt_fedselect_masking/outputs/all_final"

# The folder where the GIFs will be saved
OUTPUT_FOLDER = "/home/jolle/mmdet/mmdetection3d/projects/analysis/cmt_fedselect_masking/outputs/gifs_final"
...
def create_model_gif(model_letter, input_path, output_path, duration):
    ...
    for f in os.listdir(input_path):
        ...
        if re.search(rf"Round_\d+_model_{model_letter}\.png", f, re.IGNORECASE):
...
if __name__ == '__main__':
    ...
    if not os.path.exists(in_dir):
        ...
        for model in models:
            create_model_gif(model, in_dir, out_dir, frame_time)
